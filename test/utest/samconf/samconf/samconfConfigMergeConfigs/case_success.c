...
int samconfTestSamconfConfigMergeConfigsSuccessSetup(UNUSED void **state) {
    ...
    result = samconfUtilCreateMockConfigFromStr(_TEST_CONFIG_DEF, false, defConfig);
    ...
    result = samconfUtilCreateMockConfigFromStr(_TEST_CONFIG_JSON, false, jsonConfig);
    assert_int_equal(result, SAMCONF_CONFIG_OK);
    ...
    result = samconfUtilCreateMockConfigFromStr(_TEST_CONFIG_DLT, false, dltConfig);
    assert_int_equal(result, SAMCONF_CONFIG_OK);
...
int samconfTestSamconfConfigMergeConfigsSuccessTeardown(UNUSED void **state) {
    samconfConfigStatusE_t result;
...
void samconfTestSamconfConfigMergeConfigsSuccess(UNUSED void **state) {
    ...
    SHOULD("%s", "merge given configs to root config");
